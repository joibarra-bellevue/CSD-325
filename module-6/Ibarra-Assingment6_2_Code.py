            ...
            for y in range(forest['height']):
                ...
                if ((forest[(x, y)] == EMPTY)
                    ...
                    for ix in range(-1, 2):
                        for iy in range(-1, 2):
                            neighbor = (x + ix, y + iy)
                            #fire cannot spread into water - JI
    ...
    for y in range(forest['height']):
        for x in range(forest['width']):
            ...
            if cell == TREE:
                ...
                bext.fg('red')
                print(FIRE, end='')
            elif cell == WATER:  #water cells in blue - JI 
                bext.fg('blue')
                print(WATER, end='')
            else:
                print(EMPTY, end='')
